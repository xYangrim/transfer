...
function isValidPlacement(startRow, startCol, length, direction) {
 ...
 // Create algorithm to randomly place 4 ships horizontally or vertically

 /*
 - One two-unit ship         | 1 x 2 
 - Two three-unit ships   2x | 1 x 3 
 - One four-unit ship        | 1 x 4
 - One five-unit ship        | 1 x 5
 */

 // If ship will intersect, place in different location
